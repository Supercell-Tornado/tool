#!/bin/bash
GMTTOOLDIR=/work42/inokuchi/Tools/gmt
#################################################################
########################## [ 設定事項 ] ##########################
#################################################################
s_station_num=1
...
##################### [ 設定関連の読み込み ] ######################
#################################################################
DATADIR=/work42/inokuchi/2017_0809_gust-tornado/Maeda_Winds
DATE=20170809
GMT_TOOL_DIR=/work42/inokuchi/Tools/newmek
LOG_DIR=${GMT_TOOL_DIR}/horizontalmeanwind
log="tee ${LOG_DIR}/winddata_writing_error.log"
TOPODIR=/work42/inokuchi/Tools/gmt/TOPO
missing_value="-99.9"
sample_speed="5"
